...
pkg/binutils.cpio.zst: src/binutils-$(BINUTILS_VER).tar.xz pkg/expect.cpio.zst pkg/texinfo.cpio.zst pkg/isl.cpio.zst pkg/texinfo.cpio.zst pkg/expect.cpio.zst
	cat pkg/zlib.cpio.zst | zstd -d | cpio -idumH newc --quiet -D / > /dev/null 2>&1
