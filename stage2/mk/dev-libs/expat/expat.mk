...
#	wget -O $@  --no-check-certificate https://sourceforge.net/projects/expat/files/expat/$(EXPAT_VER)/expat-$(EXPAT_VER)-RENAMED-VULNERABLE-PLEASE-USE-2.6.2-INSTEAD.tar.xz && touch $@
	wget -P src --no-check-certificate https://github.com/libexpat/libexpat/releases/download/$(EXPAT_VER0)/expat-$(EXPAT_VER).tar.xz && touch $@
